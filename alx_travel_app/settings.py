...
# Define BASE_DIR first, so we can use it when loading .env
...
print("Looking for .env in:", BASE_DIR)
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # or use IsAuthenticated for stricter APIs
    ]
}
